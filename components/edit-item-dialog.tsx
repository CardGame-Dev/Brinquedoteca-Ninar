...
export function EditItemDialog({ open, onOpenChange, itemToEdit, onItemChanged }: EditItemDialogProps) {
  ...
  const [previewImage, setPreviewImage] = useState<string | null>(null); // Armazena a imagem de pré-visualização
  ...
  const handleImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      setImageFile(file);
      setPreviewImage(URL.createObjectURL(file)); // Atualiza a pré-visualização com a nova imagem
    }
  };
